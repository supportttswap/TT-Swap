...
var KTGeneralBlockUI = {
    init: function () {
        ...
        e = document.querySelector("#kt_block_ui_1_button"),
            ...
            n = new KTBlockUI(t), e.addEventListener("click", (function () {
                ...
                var e = document.querySelector("#kt_block_ui_3_button"),
                    ...
                    n = new KTBlockUI(t, { overlayClass: "bg-danger bg-opacity-25" });
                e.addEventListener("click", (function () {
                    n.isBlocked() ? (n.release(),
                        e.innerText = "Block") : (n.block(),
                            e.innerText = "Release")
                }))
            }(), function () {
                var e = document.querySelector("#kt_block_ui_4_button"),
                    t = document.querySelector("#kt_block_ui_4_target"),
                    n = new KTBlockUI(t); e.addEventListener("click", (function (e) {
                        e.preventDefault(), n.block(), setTimeout((function () { n.release() }), 3e3)
                    }))
            }(), function () {
                var e = document.querySelector("#kt_block_ui_5_button"),
                    t = new KTBlockUI(document.body); e.addEventListener("click", (function (e) {
                        e.preventDefault(), t.block(), setTimeout((function () { }), 3e3)
                    }))
            }()
    }
};
